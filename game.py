...
while True:
    ...
    while not done:
        ...
        # Wipe this area
        pygame.draw.rect(screen, (0, 0, 0), (screen_width - cards_left_text.get_width() - 80, screen_height - cards_left_text.get_height() - 100, cards_left_text.get_width() + 50, cards_left_text.get_height()))
        ...
        pygame.draw.rect(screen, (0, 0, 0), (screen_width - cards_left_text.get_width() - 80, screen_height - time_text.get_height() - 50, cards_left_text.get_width() + 50, time_text.get_height()))
    ...
    while done:
        ...
        if not show_ans:
            ...
            screen.blit(scaled_answer_image, (screen_width // 2 - scaled_answer_image.get_width() // 2, screen_height // 2 - 25 - scaled_answer_image.get_height() // 2))
            ...
            screen.blit(answer_text, (screen_width // 2 - answer_text.get_width() // 2, screen_height // 2 - 25 - scaled_answer_image.get_height() // 2 - answer_text.get_height() - 10))

            # Display elapsed time
            elapsed_time_text = pygame.font.SysFont("Courier New", 30).render(f"t = {elapsed_time:.3f}", True, (255, 255, 255))
            screen.blit(elapsed_time_text, (screen_width // 2 - elapsed_time_text.get_width() // 2, screen_height // 2 - 25 + scaled_answer_image.get_height() // 2 + 10))
            ...
            if pygame.time.get_ticks() / 1000 - elapsed_time - time_offset > 1:
                ...
                screen.blit(restart_text, (screen_width // 2 - restart_text.get_width() // 2, screen_height // 2 - 25 + scaled_answer_image.get_height() // 2 + 10 + elapsed_time_text.get_height() + 10))
